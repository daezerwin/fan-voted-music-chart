...
<div
    class="pointer-events-none absolute inset-x-0 bottom-0 flex flex-col gap-2 bg-gradient-to-t from-black/85 to-transparent px-3 pb-2 pt-8 opacity-0 group-hover:pointer-events-auto group-hover:opacity-100"
    @click.stop
>
    <input
        type="range"
